...
// Author: Benjamin H Good
// Contributor: Alejandro Gonzales-Irribarren
// Github: alejandrogzi/thermut
// Version: 0.0.1

// This C++ program is the statistical analysis step of the
// "Time-resolved metagenomic sequencing of Lenski's long-term 
// evolution experiment with Escherichia coli" by Benjamin H Good.
// Due to debugging, testing and compliance with the thermut pipeline,
// a few changes were made to the original code. These changes 
// DO NOT affect the core of the statistical model.
...
int main(int argc, char *argv[]){
    ...
    while(std::getline(std::cin, line)){
        ...
        // these entries not needed for this step in the pipeline
        std::getline(line_stream, chrom, ','); // chromosome
        std::getline(line_stream, item, ','); // location
        std::getline(line_stream, allele, ','); // allele

        // Debug print variables
        // std::cout << "Chromosome: " << chrom << std::endl;
        // std::cout << "Location: " << item << std::endl;
        // std::cout << "Allele: " << allele[0] << std::endl;
        ...
        while(std::getline(item_stream0, subitem, ' ')){
            if(!subitem.empty()){
                times.push_back(std::stod(subitem));
            }
        }
        ...
        while(std::getline(item_stream, subitem, ' ')){
            if(!subitem.empty()){
                alts.push_back(std::stod(subitem));
            }
        }
        
        // // Debug print alts
        // std::cout << "Alts: ";
        // for(const double& a : alts) {
        //     std::cout << a << " ";
        // }
        // std::cout << std::endl;
        ...
        while(std::getline(item_stream2, subitem, ' ')){
            if(!subitem.empty()){
                depths.push_back(std::stod(subitem));
            }
        }
    ...
    // std::cout << "Number of lines processed: " << num_processed << std::endl;
    // std::cout << "Number of lines passed: " << num_passed << std::endl;
    // std::cout << "Number of lines surprising: " << num_surprising << std::endl;
